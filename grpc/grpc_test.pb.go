...
func (c *greeterClient) SayHelloAgain(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := grpc.Invoke(ctx, "/pb.Greeter/SayHelloAgain", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptor0 = []byte{
	...
	0x8e, 0x2f, 0x49, 0x2d, 0x2e, 0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x2a, 0x48, 0x52,
	...
	0x8b, 0x13, 0xd3, 0x61, 0x8a, 0x60, 0x5c, 0xa3, 0x3c, 0x2e, 0x76, 0xf7, 0xa2, 0xd4, 0xd4, 0x92,
	0xd4, 0x22, 0x21, 0x3d, 0x2e, 0x8e, 0xe0, 0xc4, 0x4a, 0xb0, 0x2e, 0x21, 0x01, 0xbd, 0x82, 0x24,
	0x3d, 0x64, 0x4b, 0xa4, 0xf8, 0x90, 0x44, 0x0a, 0x72, 0x2a, 0x95, 0x18, 0x84, 0x8c, 0xb9, 0x78,
	0x61, 0xea, 0x1d, 0xd3, 0x13, 0x33, 0xf3, 0x88, 0xd1, 0x94, 0xc4, 0x06, 0xf6, 0x86, 0x31, 0x20,
	0x00, 0x00, 0xff, 0xff, 0x5a, 0xc4, 0x72, 0x5a, 0xd9, 0x00, 0x00, 0x00,
}
